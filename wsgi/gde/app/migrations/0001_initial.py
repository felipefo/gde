...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True, serialize=False)),
                ('nome', models.CharField(null=True, unique=True, max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Elemento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipoAcumulo', models.ForeignKey(related_name='tipoAcumulo', to='app.TipoAcumulo', blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
